      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="sv-card p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" placeholder="Meridian Growth Co." className="sv-input w-full" required />
            </div>
            <div>
              ...
              <select className="sv-input w-full appearance-none" required>
                <option value="">Select...</option>
                {["Agency", "Startup", "SMB", "Enterprise", "Freelancer"].map(o => <option key={o}>{o}</option>)}
              </select>
            </div>
          </div>
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. Done-for-you outbound systems for B2B SaaS" className="sv-input w-full" required />
          </div>
        </div>
        ...
        <div className="sv-card p-5 space-y-4">
          ...
          <div>
            ...
            <textarea rows={3} placeholder="e.g. Founders of SaaS companies with 5–50 employees, Series A or bootstrapped, struggling with outbound..."
              className="sv-input w-full resize-none" required />
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-manrope font-medium text-[#94A3B8] mb-1.5">Target Region</label>
              <input type="text" placeholder="e.g. United States, Canada" className="sv-input w-full" />
            </div>
            <div>
              <label className="block text-xs font-manrope font-medium text-[#94A3B8] mb-1.5">Primary Goal</label>
              <select className="sv-input w-full appearance-none">
                <option>Book discovery calls</option>
                <option>Generate inbound leads</option>
                <option>Build partnerships</option>
